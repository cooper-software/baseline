...
var expect = require("chai").expect,
	...
	tree = require('../../baseline/annotations/AnnotationTree'),
	AnnotationTree = tree.AnnotationTree,
	AnnotationTreeNode = tree.AnnotationTreeNode,
...
describe("annotations.AnnotationTree", function ()
{
	it("has a method to tell if its empty or not", function ()
	{
		...
		{
			root: new AnnotationTreeNode({ annotation: new Annotation({ type: type_b, offset: 0, length: 3 }) })
		})
